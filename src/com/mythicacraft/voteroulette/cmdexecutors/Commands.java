			...
			if(args.length == 0) {
				...
				if(args[0].equalsIgnoreCase("deletemilestone")) {
					...
					if(args.length == 1) {
						...
						sender.sendMessage(ChatColor.GOLD + "-----" + ChatColor.GREEN + plugin.VOTE_DEF + " " + plugin.STATS_DEF + ": " + ChatColor.YELLOW + sender.getName() + ChatColor.GOLD + "-----"); //header of page with current and total pages
						...
						message = message + ChatColor.YELLOW + "\n" + plugin.LONGEST_VOTE_STREAK_DEF + ": " + ChatColor.AQUA + longestVoteStreak;
						sender.sendMessage(ChatColor.GOLD + "-----" + ChatColor.GREEN + plugin.VOTE_DEF + " " + plugin.STATS_DEF + ": " + ChatColor.YELLOW + otherPlayer + ChatColor.GOLD + "-----"); //header of page with current and total pages
						sender.sendMessage(message);
					}
