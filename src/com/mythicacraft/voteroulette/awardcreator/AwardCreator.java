...
public class AwardCreator {
	...
	public void goToStage(AwardCreationStage stage, boolean isGoingBack) {
		...
		case ADD_DESCRIPTION:
			...
			break;
		case ADD_ITEMS:
			player.sendMessage(ChatColor.AQUA + "*" + ChatColor.YELLOW + " To add items to this " + awardType.toString().toLowerCase() + ", the items must be in your inventory. Make sure your inventory reflects what you want the award to give.");
		...
		case CHOOSE_PRIZE:
			...
			player.sendMessage(ChatColor.AQUA + "*" + ChatColor.YELLOW + " Choose a prize type to add for " + ChatColor.AQUA + award.getName() + ChatColor.YELLOW + ":");
			player.sendMessage(ChatColor.GRAY + "Prizes: " + ChatColor.GOLD + "items" + ChatColor.GRAY + ", " + ChatColor.GOLD + "xp" + ChatColor.GRAY + ", " + ChatColor.GOLD + "currency" + ChatColor.GRAY + ", or " + ChatColor.GOLD + "commands" + ChatColor.GRAY + ".");
			player.sendMessage(ChatColor.YELLOW + "Enter a prize type or " + ChatColor.GOLD + "back" + ChatColor.YELLOW + " to go back.");
			break;
		case FINAL_CONFIRMATION:
			player.sendMessage(ChatColor.AQUA + "*" + ChatColor.YELLOW + " Confirm the creation of " + award.getAwardType().toString().toLowerCase() + " " + ChatColor.AQUA + award.getName() + ChatColor.YELLOW + ":");
			player.sendMessage(ChatColor.YELLOW + "Type " + ChatColor.GOLD + "save" + ChatColor.YELLOW + " to finish, " + ChatColor.GOLD + "preview" + ChatColor.YELLOW + " to see the " + award.getAwardType().toString().toLowerCase() + ", or " + ChatColor.GOLD + "back" + ChatColor.YELLOW + " to go back.");
			break;
		case NAME:
			player.sendMessage(ChatColor.AQUA + "*" + ChatColor.YELLOW + " Please type a name for this new " + awardType.toString().toLowerCase() + ", or " + ChatColor.GOLD + "back" + ChatColor.YELLOW + " to go back:");
			break;
		case SET_PRIORITY:
			player.sendMessage(ChatColor.AQUA + "*" + ChatColor.YELLOW + " Please enter the priority for this " + awardType.toString().toLowerCase() + ", or " + ChatColor.GOLD + "back" + ChatColor.YELLOW + " to go back:");
